...
function getContactSiteBuild(): AbstractSiteBuildLayer
{
    ...
    $index_content = new PhpFileSiteBuildLayer();
    $index_content->setPhpFilePath(__DIR__ . '/templates/content_contact.php');
    $index_content->setVariable('name', 'John Doe');
    $index_content->setVariable('phone', '+1-541-754-3010');
    $index_content->setVariable('email', 'email@example.com');
